...
namespace schedule_tracker.Services
{
    public interface IScheduleService
    {
        ...
        Task<IEnumerable<ScheduleTodayDto>> GetSchedulesAsync(int userId, string? search, string? category, string? priority, bool? completed, DateTime? date, string? sortBy);
