...
const Button = ({ 
  ...
  const variants = {
    primary: "bg-brand-600 text-white hover:bg-brand-700 shadow-sm hover:shadow-md hover:-translate-y-0.5",
    secondary: "bg-white text-slate-700 border border-slate-200 hover:border-slate-300 hover:bg-slate-50 shadow-sm",
    ghost: "bg-transparent text-slate-600 hover:bg-slate-100",
    destructive: "bg-red-50 text-red-600 hover:bg-red-500 hover:text-white",
  };
